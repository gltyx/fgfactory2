        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="row gx-2 align-items-center">
                    ...
                    <div class="col-auto">
                        <div v-if="data.lab.state == 'paused' || data.lab.tech.id != data.id" class="text-center small mb-1"><FormatTime :value="data.time" /></div>
                        <div v-if="data.lab.state != 'paused' && data.lab.tech.id == data.id" class="text-center small mb-1"><FormatTime :value="data.lab.remainingTime" /></div>
                    ...
                    <div class="col-auto">
                        ...
                        <button v-if="data.lab.state == 'running'" type="button" class="btn btn-dark p-2 small" :class="{ 'disabled opacity-25':data.lab.tech.id != data.id }" style="width:32px; height:32px;" @click="data.lab.pauseResearching();">
                            <i class="fas fa-fw fa-stop small"></i>
                        </button>
                        <button v-if="data.lab.state == 'waiting'" type="button" class="btn btn-dark p-2 small" :class="{ 'disabled opacity-25':data.lab.tech.id != data.id }" style="width:32px; height:32px;" @click="data.lab.pauseResearching();">
...
export default {
    ...
    computed: {
        ...
        percent() {
            ...
            if (this.data.lab.tech.id != this.data.id) return 0
