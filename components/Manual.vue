<template>
    <div v-if="$parent.currentMachineSubTabId == 'manual'" class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row gx-3 align-items-center">
                    ...
                    <div class="col-4"><ManualGroup :data="data.groups[4]" /></div>
                </div>
                <div class="row gx-3 align-items-center">
                ...
                <div class="row gx-3 align-items-center">
                    <div class="col-12 small"><span class="fw-bold text-muted">Machines</span></div>
                ...
                <div class="row gx-3 align-items-center">
                    ...
                    <div class="col-12"><ManualGroup :data="data.groups[16]" /></div>
                </div>
                <div class="row gx-3 align-items-center">
                    <div class="col-12 small"><span class="fw-bold text-muted">Storages</span></div>
                    <div class="col-12"><ManualGroup :data="data.groups[17]" /></div>
                </div>
            </div>
        </div>
    </div>
