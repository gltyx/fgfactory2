<template>
    <div v-if="data.recipe.isUnlocked() == true" class="card card-body p-1">
        <div class="row gx-2 align-items-center">
            <div v-if="data.recipe != null" class="col row gx-2 align-items-center justify-content-end me-2">
                ...
                <div v-if="data.recipe.inputs" class="col-auto small"><i class="text-muted fas fa-fw fa-long-arrow-alt-right"></i></div>
