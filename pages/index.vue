...
var baseData = [
    ...
    { id:'rail',                        type:'item',        machines:[ 'assembler1', 'assembler2', 'assembler3' ],           max:50,   storages:[ 'woodChest', 'ironChest', 'steelChest' ], time:.5,  inputs:{ ironStick:1, steelPlate:1, stone:1 }, outputs:{ rail:2 }, reqs:[ 'railway' ], },    
    ...
    { id:'battery',                     type:'item',        machines:[ 'chemicalPlant' ],                                    max:50,   storages:[ 'woodChest', 'ironChest', 'steelChest' ], time:4,   inputs:{ copperPlate:1, ironPlate:1, sulfuricAcid:20 }, outputs:{ battery:1 }, reqs:[ 'batteryTech' ], },
    ...
    { id:'electricEngineUnit',          type:'item',        machines:[ 'assembler2', 'assembler3' ],                         max:50,   storages:[ 'woodChest', 'ironChest', 'steelChest' ], time:1,   inputs:{ electronicCircuit:2, engineUnit:1, lubricant:15 }, outputs:{ electricEngineUnit:1 }, reqs:[ 'electricEngineTech' ], },
    ...
    { id:'shotgunShells',               type:'item',        machines:[ 'manual', 'assembler1', 'assembler2', 'assembler3' ], max:200,   storages:[ 'woodChest', 'ironChest', 'steelChest' ], time:3,  inputs:{ copperPlate:2, ironPlate:2 }, outputs:{ shotgunShells:1 }, reqs:[ 'military1' ], },
...
class Generator extends Item {
    ...
    getConsum() {
        ...
        let count = this.used > 0 ? this.used : 1
